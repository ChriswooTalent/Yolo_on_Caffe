#ifndef CAFFE_YOLOV3_DETECTION_LAYER_HPP_
#define CAFFE_YOLOV3_DETECTION_LAYER_HPP_
...
namespace caffe {
	...
	class Yolov3DetectLayer : public Layer < Dtype > {
	public:
		explicit Yolov3DetectLayer(const LayerParameter& param)
			: Layer<Dtype>(param) {}
